...
Workouts.prototype.userInput = function(event){
  ...
  var slimSix = new Workouts('Slim in 6', [1, 2, 3], [2], ['tone', 'cardio'], '<h4>Choose Your Workout</h4><img class="left" id="workoutLogo" src="img/slimin6.jpg" alt="BeachBody logo"></img><p id="workoutText">Combines cardio with light resistance moves to burn fat and reshape your body in 6 weeks.</p>');
  var turboJam = new Workouts('Turbo Jam', [1, 2, 3], [3], ['dance', 'tone'], '<h4>Choose Your Workout</h4><img class="left" id="workoutLogo" src="img/turbojam.jpg" alt="BeachBody logo"></img><p id="workoutText">Kickboxing and body sculpting to the hottest tunes to burn more calories than almost any other exercise.</p>');
  var hipHopAbs = new Workouts('Hip Hop Abs', [1, 2], [2], ['dance', 'tone', 'express'], '<h4>Choose Your Workout</h4><img class="left" id="workoutLogo" src="img/hiphopabs.jpg" alt="BeachBody logo"></img><p id="workoutText">Fun hip hop dance moves set to hot music to burn fat and sculpt lean sexy abs.</p>');
  var chaLean = new Workouts('ChaLEAN Extreme', [2], [3], ['tone', 'extreme'], '<h4>Choose Your Workout</h4><img class="left" id="workoutLogo" src="img/chaleanextreme.jpg" alt="BeachBody logo"></img><p id="workoutText">The proven 3-phase circuit training technique is guaranteed to give you results every 30 days—the more muscle you build, the more fat your burn because Muscle Burns Fat®!</p>');
  var rockinBody = new Workouts('Rockin\' Body', [1, 2], [2], ['dance', 'tone'], '<h4>Choose Your Workout</h4><img class="left" id="workoutLogo" src="img/rockinbody.jpg" alt="BeachBody logo"></img><p id="workoutText">Calorie-burning cardio and full-body sculpting moves. Party off the pounds as you dance and sweat to the hottest hits of all time!</p>');
